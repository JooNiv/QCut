...
**Here we will briefly go over where the decomposition used for wire cuts comes from and how that is transfromed to operations implementable on a quantum computer. The derivation is based on [[1][2]](#ref).**
