...
def get_qpd_insert_order(cut_locations: list) -> list:
    ...
    for index, (tuple_vals, outer_value) in enumerate(cut_locations):
        for tuple_value in tuple_vals:
            value_indices.append((tuple_value, index, outer_value))  # noqa: PERF401
